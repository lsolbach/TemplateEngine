...
public class BeanDataSourceTest extends TestCase {
	...
	public void testGetSymbolTable() {
		...
		assertEquals(TestBean.STRING_VALUE, ((StringValue) st.getSymbol(TestBean.STRING_VALUE)).getData(), "Test");
	...
	public void testStringAttribute() {
		...
		assertTrue("Correct symbol type: StringSymbol", symbol instanceof StringValue);
		assertEquals(TestBean.STRING_VALUE, value, ((StringValue) symbol).getData());
	...
	public void testIntegerAttribute() {
		...
		assertNotNull("Symbol found: ", symbol);
		assertTrue("Correct symbol type: NumericSymbol", symbol instanceof NumericValue);
		assertEquals(TestBean.INTEGER_VALUE, String.valueOf(value), ((NumericValue) symbol).getData());
	...
	public void testLongAttribute() {
		...
		assertNotNull("Symbol found: ", symbol);
		assertTrue("Correct symbol type: NumericSymbol", symbol instanceof NumericValue);
		assertEquals(TestBean.LONG_VALUE, String.valueOf(value), ((NumericValue) symbol).getData());
	...
	public void testShortAttribute() {
		...
		assertNotNull("Symbol found: ", symbol);
		assertTrue("Correct symbol type: NumericSymbol", symbol instanceof NumericValue);
		assertEquals(TestBean.SHORT_VALUE, String.valueOf(value), ((NumericValue) symbol).getData());
	...
	public void testByteAttribute() {
		...
		assertNotNull("Symbol found: ", symbol);
		assertTrue("Correct symbol type: NumericSymbol", symbol instanceof NumericValue);
		assertEquals(TestBean.BYTE_VALUE, String.valueOf(value), ((NumericValue) symbol).getData());
	...
	public void testFloatAttribute() {
		...
		assertNotNull("Symbol found: ", symbol);
		assertTrue("Correct symbol type: NumericSymbol", symbol instanceof NumericValue);
		assertEquals(TestBean.FLOAT_VALUE, String.valueOf(value), ((NumericValue) symbol).getData());
	...
	public void testDoubleAttribute() {
		...
		assertNotNull("Symbol found: ", symbol);
		assertTrue("Correct symbol type: NumericSymbol", symbol instanceof NumericValue);
		assertEquals(TestBean.DOUBLE_VALUE, String.valueOf(value), ((NumericValue) symbol).getData());
	...
	public void testBooleanGetAttribute() {
		...
		assertNotNull("Symbol found: ", symbol);
		assertTrue("Correct symbol type: 'StringSymbol' found " + symbol.getClass().getName(), symbol instanceof StringValue);
		assertEquals(TestBean.BOOLEAN_GET_VALUE, value ? "1" : "0", ((StringValue) symbol).getData());
	}
	...
	public void testBooleanIsAttribute() {
		...
		assertTrue("Correct symbol type 'StringSymbol' found " + symbol.getClass().getName(), symbol instanceof StringValue);
		assertEquals(TestBean.BOOLEAN_IS_VALUE, value ? "1" : "0", ((StringValue) symbol).getData());
	...
	public void testListAttribute() {
		...
		ds = new BeanDataSourceImpl(ts);
		st = ds.getSymbolTable();
		assertTrue("Correct symbol type: NumericSymbol", (symbol = st.getSymbol(TestBean.DOUBLE_VALUE)) instanceof NumericValue);
		assertEquals(TestBean.DOUBLE_VALUE, String.valueOf(value), ((NumericValue) symbol).getData());
