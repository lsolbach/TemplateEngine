...
public class StringHelper {
  ...
  /**
   * Splits an input string into a token list with the use of a delimiter string. Adds empty strings when two delimiters follow immediately after each other.
   * @param input
   * @param delim
  ...
  /**
   * Returns a substring until the first carriage return and/or line feed. Used to remove carriage return/line feed from a string.
   * @param input Line string
   * @return String
   */
